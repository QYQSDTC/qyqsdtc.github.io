...
![000965.png]({{site.baseurl}}/assets/img/r2TEMbQEf-000965.png)
...
![fitting_performance.png]({{site.baseurl}}/assets/img/HaU_F-5EF-fitting_performance.png)

这样我们就得出了4月26日的关于该股的分数，可见*k*是很小的，所以$\alpha\,$也会很小，代表该股的趋势已经过去了。依次类推，我们可以计算出$41-29=12$个得分，我们把得分和收盘价画在一张图上
![annualized_returns.png]({{site.baseurl}}/assets/img/j8SWEgEnZ-annualized_returns.png)
...
一次函数的拟合结果如下
![fitting_performance2.png]({{site.baseurl}}/assets/img/QvBiSAw9r-fitting_performance2.png)
可以看到拟合出的斜率为负，也说明该股的时代已经过去了。同样的为他计算12天的得分，并且和Mod 1 一起展示出来
![score_variation.png]({{site.baseurl}}/assets/img/keoeUGvpc-score_variation.png)
