...
This combination makes NeoVim the fastest LaTex editor on macOS. Inspired by [How I'm able to take notes in mathematics lectures using LaTex and Vim](https://castel.dev/post/lecture-notes-1/) and mainly referred [this blog](https://ejmastnak.github.io/tutorials/vim-latex/pdf-reader.html#a-pdf-reader-on-macos) for issues during the installation and test.
