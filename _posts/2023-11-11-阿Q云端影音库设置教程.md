...
![关闭资源库]({{site.baseurl}}/assets/img/closesync.PNG)
...
打开软件进入媒体库
![media]({{site.baseurl }}/assets/img/vidhubmedia.PNG)

然后选择Emby，根据下图输入服务器地址和账号密码
![emby]({{site.baseurl}}/assets/img/EmbyConnect.JPG)
...
![wechat]({{site.baseurl}}/assets/img/wechatgroup.JPG)
